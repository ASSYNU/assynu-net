...
const Home: NextPage = () => {
  return (
    <div className={styles.container}>
      <Head>
        <title>Dawid Bartczak - Technologies</title>
        <meta name="description" content="Dawid Bartczak's Technologies" />
        ...
        <div className={styles.flexContainer}>
          ...
          >
            <Card.Img
              variant="top"
              className="rounded-2xl mb-3"
              src="https://i0.wp.com/giaiphapso.com/wp-content/uploads/2021/08/cplusplus.png?resize=770%2C433&ssl=1"
            />
            <Card.Body>
              <Card.Title className="text-3xl text-center">C++</Card.Title>
            </Card.Body>
          </Card>
        </div>
        <div className={styles.flexContainer}>
